...
wget -c https://github.com/patryckpinhal/issabel-construtor/raw/main/sql2.tgz
tar zvxf sql2.tgz
rm -f sql2.tgz
...
chmod +x build monitfilas static download
chown -R root:root build download.php monitfilas static
